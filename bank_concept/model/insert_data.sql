INSERT INTO `bank`.`sub_bank` (`bank_name`, `bank_location`, `asset`) VALUES ('xx1分行', '合肥', '20000000');
INSERT INTO `bank`.`sub_bank` (`bank_name`, `bank_location`, `asset`) VALUES ('xx2分行', '上海', '20000000');

INSERT INTO `bank`.`department` (`depart_no`, `bank_name`, `depart_name`, `depart_type`) VALUES ('1', 'xx1分行', '服务部门', '服务');
INSERT INTO `bank`.`department` (`depart_no`, `bank_name`, `depart_name`, `depart_type`) VALUES ('2', 'xx1分行', '记账部门', '记账');
INSERT INTO `bank`.`department` (`depart_no`, `bank_name`, `depart_name`, `depart_type`) VALUES ('3', 'xx2分行', '服务部门', '服务');
INSERT INTO `bank`.`department` (`depart_no`, `bank_name`, `depart_name`, `depart_type`) VALUES ('4', 'xx2分行', '记账部门', '记账');

INSERT INTO `bank`.`member` (`ID`, `depart_no`, `Dep_depart_no`, `bank_name`, `name`, `sex`, `Person_ID`, `Phone`, `Address`, `Salary`, `Begin_date`, `level`) VALUES ('1', '1', '1', 'xx1分行', 'b', 'M', '100000000000000001', '10000000001', 'abcD1-2-304', '100000', '2019-1-1', '7');
INSERT INTO `bank`.`member` (`ID`, `depart_no`, `Dep_depart_no`, `bank_name`, `name`, `sex`, `Person_ID`, `Phone`, `Address`, `Salary`, `Begin_date`, `level`) VALUES ('2', '2', '2', 'xx1分行', 'c', 'W', '100000000000000000', '20000000000', 'ac 4-5-607', '100000', '2018-01-01', '8');
INSERT INTO `bank`.`member` (`ID`, `depart_no`, `Dep_depart_no`, `bank_name`, `name`, `sex`, `Person_ID`, `Phone`, `Address`, `Salary`, `Begin_date`, `level`) VALUES ('3', '3', '3', 'xx2分行', 'x', 'W', '200000000000000000', '12300000001', '下北泽', '900000', '2018-07-01', '7');
INSERT INTO `bank`.`member` (`ID`, `depart_no`, `Dep_depart_no`, `bank_name`, `name`, `sex`, `Person_ID`, `Phone`, `Address`, `Salary`, `Begin_date`, `level`) VALUES ('4', '4', '4', 'xx2分行', 'y', 'M', '200000000000000001', '12300000002', '编不出来了', '900000', '2018-08-01', '7');
INSERT INTO `bank`.`member` (`ID`, `Dep_depart_no`, `bank_name`, `name`, `sex`, `Person_ID`, `Phone`, `Address`, `Salary`, `Begin_date`, `level`) VALUES ('100', '1', 'xx1分行', 'a', 'M', '100000000000000011', '10000000000', 'abc1-2-304', '5000', '2023-05-29', '1');
INSERT INTO `bank`.`member` (`ID`, `Dep_depart_no`, `bank_name`, `name`, `sex`, `Person_ID`, `Phone`, `Address`, `Salary`, `Begin_date`, `level`) VALUES ('200', '4', 'xx2分行', 'z', 'W', '200000000000000022', '12300000000', '电波塔', '6000', '2022-04-02',  '2');
